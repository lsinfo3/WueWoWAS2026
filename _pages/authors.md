...
# Copyright Form
The upload of the camera-ready version to EDAS additionally requires the upload of a written declaration of consent for publishing on the institutional repository of the University of Würzburg. The required IEEE copyright form is available <a href="../assets/forms/Autorenvertrag_OPUS_en_WueWoWAS26.pdf"> here</a>.

# Registration Deadline
Please note that **at least one author** must be registered by **September 4th** to have the paper included in the proceedings. Please follow the registration instructions under the tab [Registration](https://lsinfo3.github.io/WueWoWAS2026/registration/).

# Presenter
Please specify a presenter for the talk by September 4th via EDAS. We also ask you to include a short bio of the presenter in EDAS.
